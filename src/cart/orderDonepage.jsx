...
const OrderConfirmationPage = () => {
  ...
  return (
    <div className=' relative bg-yellow-50 bg-opacity-65 bg-cover pt-16'>
      ...
      <div className="p-8 mt-20 max-w-xl ml-24 absolute inset-0">
        ...
        {address && (
          <div className="mt-8">
            ...
            <p className="text-lg text-gray-700">{address.name}</p>
            <p className="text-lg text-gray-700">{address.email}</p>
