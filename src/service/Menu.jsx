...
//   return (
//     <div className='bgg h-full pt-7 lg:pt-16 pb-5'>
//       {/* Header Section */}
//       <div className='mt-16 flex flex-col justify-center items-center lg:mt-16 '
//            data-aos="fade-up"  data-aos-once='true'  data-aos-delay="400" data-aos-easing="ease-in-out" data-aos-duration="800">
...
//              data-aos="fade-up"  data-aos-once='true'  data-aos-delay="200" data-aos-easing="ease-in-out" data-aos-duration="700">
...
function Menu() {
  ...
  const [addedItemImage, setAddedItemImage] = useState(null);
  ...
  const addToCart = (dish) => {
    ...
    setAddedItemImage(dish.image || Dosa);
    
    setTimeout(() => {
      setAddedItem(null);
      setAddedItemImage(null);
    }, 3000);
  };

  return (
    <div className='bgg h-full pt-7 lg:pt-16 pb-5'>
      {/* Floating Cart Notification with Image */}
      {addedItem && (
        <div className="fixed top-12 right-8 bg-white text-yellow-600 px-4 py-2 rounded-lg shadow-lg flex items-center space-x-4 transition-opacity duration-300">
          <img src={addedItemImage} alt={addedItem} className="h-12 w-12 rounded-full object-cover" />
          <span>{addedItem} <br /> added to cart</span>
        </div>
      )}
