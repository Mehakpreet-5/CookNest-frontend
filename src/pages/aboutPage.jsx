...
function AboutPage() {
  return (
    <>
      <div className='flex flex-col md:flex-row bgg pt-10 pb-10 lg:pb-28 md:pt-24 justify-center items-center px-4 space-y-6 md:space-x-14 lg:space-x-14'>
  {/* Image Section */}
  <img
    src={design}
    alt="About"
  ...
  {/* Text Section */}
  <div
    className='w-full md:w-5/12  md:text-left px-2 lg:px-4 greenn mt-7 lg:mt-40'
    data-aos="fade-up"
    data-aos-delay="700"
    data-aos-easing="ease-in-out"
    data-aos-duration="1100"
  >
    ...
    <h1 className='font-bold text-3xl md:text-5xl mb-4 dark-orange fontt'>
    ...
    <div className='text-gray-700 lg:w-5/6'>
      <ul className='list-disc grid lg:grid-cols-2 space-x-8 lg:space-x-4 space-y-1  md:text-base greenn md:font-medium'>
        <li className='ml-8 lg:ml-4'>Fresh and Fast Food Delivery</li>
        <li>24/7 Customer Support</li>
        <li>Easy Customization </li>
        <li>Delicious Deals for Meals</li>
      </ul>
    </div>
    ...
    <div className='hidden sm:block'>
      <img
        src={ss1}
        alt="About"
        className='h-24 w-64 mx-auto mt-8 lg:mt-0 lg:ml-96'
      />
    </div>
  </div>
</div>
      ...
      {/* What We Offer */}
      <div className='p-6 bg-yellow-50 bg-opacity-15 greenn mt-6'>
        <div className='text-center'
          data-aos="fade-up" data-aos-delay="400" data-aos-easing="ease-in-out" data-aos-duration="600">
          <div className=' flex flex-col justify-center items-center '> 
          <h1 className=' py-2 bgg border border-yellow-600 border-opacity-50 flex justify-center items-center rounded-full uppercase text-center  w-40 h-8'>our service</h1> <br />
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 lg:gap-8'>
            {servicesList.map((service, index) => (
              <div
                ...
                data-aos="fade-up"  data-aos-delay="500" data-aos-easing="ease-in-out" data-aos-duration="700">
