        ...
        <div className='bgg  h-4/5 w-full lg:pb-16  greenn'>
            <div className='flex flex-col lg:flex-row justify-center items-center lg:px-0 pt-12'>
                ...
                <div className='jump w-full lg:w-5/12  lg:mt-28 space-y-4 lg:space-y-1 px-4 lg:px-0 lg:ml-72 '
                 data-aos="fade-down"  data-aos-delay="700" data-aos-easing="ease-in-out" data-aos-duration="800">
                    ...
                    <h1 className='fontt text-5xl md:text-4xl lg:text-8xl text-center lg:text-left lg:mb-20'>
                    Delicious Catering  <br /> <span className="oragg ">& </span>Home Delivery Solutions
                    </h1>
                ...
                {/* Image Container */}
                <div className='w-4/5 lg:w-2/6 flex justify-center mt-14 lg:mt-32 lg:mr-64 lg:ml-2 '
                    data-aos="zoom-in"  data-aos-delay="300" data-aos-easing="ease-in-out" data-aos-duration="800" >
