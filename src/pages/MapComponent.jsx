...
<div className='flex flex-row space-x-3  justify-center lg:pt-5 lg:pl-10 pb-20 bg-yellow-50 bg-opacity-20'> 
    ...
    {/* Happy Customers Box */}
    <div className='bg-yellow-600 ml-7  lg:ml-0 bg-opacity-50 h-52 w-72 lg:h-60 lg:w-56 rounded-xl flex flex-col items-center justify-center p-4'>
      <FontAwesomeIcon icon={faUsers} className="text-6xl lg:text-7xl text-white" />
      <h1 className='text-4xl lg:text-5xl mt-4 mb-2 font-semibold fontt'>679</h1>
      <h3 className='text-lg font-semibold'>Happy Customers</h3>
    </div>
        {/* Expert Chiefs Box */}
        <div className='bg-yellow-600 bg-opacity-50 h-52 w-72 lg:h-60 lg:w-56 rounded-xl flex flex-col items-center justify-center p-4'>
      <FontAwesomeIcon icon={faUserPlus} className="text-6xl lg:text-7xl ml-2 lg:ml-0 text-white" />
      <h1 className='text-4xl lg:text-5xl mt-4 mb-2 font-semibold fontt'>52</h1>
    ...
    <div className='bg-yellow-600 bg-opacity-50 h-52 w-72 lg:h-60 lg:w-56 rounded-xl flex flex-col items-center justify-center p-4'>
      ...
      <h1 className='text-4xl lg:text-5xl mt-4 mb-2 font-semibold fontt'>123</h1>
      <h3 className='text-lg font-semibold'>Event Completed</h3>
    </div>
      </div>
      <div className=' hidden sm:block h-2/5 w-2/5 lg:mt-4 '>  <img src={picc} alt="Gallery" className=" ml-12 lg:ml-5 h-5/6 lg:h-full lg:w-full lg:px-12  w-5/6" /></div>
    </div> 
    </>
  );
}
